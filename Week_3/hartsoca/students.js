...
Student.prototype.logMe = function(tru) {
	if(tru == true) {
...
function sortArr(comparator, array) { //bubble sort
...
switch(student2.club.toLowerCase()) {
	case "improv":
		s2 = 4;
		break;
	case "cat":
...
console.log("**********");
console.log(printArr(sortArr(yearComparator,students),true));
console.log("**********");
console.log(printArr(sortArr(majorComparator,students),true));
console.log("**********");
console.log(printArr(sortArr(clubComparator,students),false));
console.log("**********");
